 ...
 * @author jo
 */
@WebServlet(name = "BakedGoodsServlet", urlPatterns = {"/BakedGoodsServlet"})
public class BakedGoodsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<BakedGoods> goods = port.getAllBakedGoods();
            ...
            try (PrintWriter out = response.getWriter()) {
                out.println(HelperClassGoods.getHTML(goods, "Baked Goods Menu"));
            }
