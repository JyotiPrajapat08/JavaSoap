 ...
 * @author jo
 */
@WebServlet(name = "AddBakedGoodsServelet", urlPatterns = {"/AddBakedGoodsServelet"})
public class AddBakedGoodsServelet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       BakeImplService service = new BakeImplService();
        ...
        String result = port.insertBakedGoods(Integer.parseInt(request.getParameter("id")), request.getParameter("name"),Double.parseDouble(request.getParameter("price")));
