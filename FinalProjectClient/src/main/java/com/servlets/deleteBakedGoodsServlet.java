 ...
 * @author jo
 */
@WebServlet(name = "deleteBakedGoodsServlet", urlPatterns = {"/deleteBakedGoodsServlet"})
public class deleteBakedGoodsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       BakeImplService service = new BakeImplService();
        ...
        String result = port.deleteBakedGoods(Integer.parseInt(request.getParameter("id")));
